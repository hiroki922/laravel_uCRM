                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input type="radio" id="gender" v-model="form.gender" value="1" name="gender" :value="0">
                                                    <label for="gender" class="ml-2 mr-4">男性</label>
                                                    <input type="radio" id="gender" v-model="form.gender" value="0" name="gender" :value="1">
                                                    <label for="gender" class="ml-2 mr-4">女性</label>
                                                    <input type="radio" id="gender" v-model="form.gender" value="0" name="gender" :value="2">
